...
public class Game extends Canvas {
	...
	private static int alienRow = 5;
	private static int aliensPerRow = 12;
	...
	public Game() {
		...
		//TODO: create a frame for a game. So it is possible to pick one game and visualize it
...
//		addKeyListener(new KeyInputHandler());
	...
	private void initEntities() {
		...
		alienCount = 0;
		for (int row=0;row<alienRow;row++) {
